...
public class TestCreditCard {
	...
	public static void main(String[] args) {
		...
		myCards[ 0 ] = new MasterCrook( idnum1, new Money(fee1));
		...
		myCards[ 1 ] = new DishonestExpress(idnum2, interest2);
		...
		((MasterCrook)myCards[ 0 ]).chargeCard( new Money(chargeAmount) );
		((DishonestExpress)myCards[ 1 ]).chargeCard( new Money(chargeAmount) );
